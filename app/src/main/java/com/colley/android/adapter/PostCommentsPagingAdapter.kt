...
class PostCommentsPagingAdapter (
    ...
    private val clickListener: PostCommentItemClickedListener,
        ) : PagingDataAdapter<DataSnapshot, PostCommentViewHolder>(COMMENT_COMPARATOR) {

    interface PostCommentItemClickedListener {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): PostCommentViewHolder {
        ...
        return PostCommentViewHolder(viewBinding)
    }

    override fun onBindViewHolder(viewHolder: PostCommentViewHolder, position: Int) {
...
class PostCommentViewHolder(private val itemBinding: ItemCommentBinding)
